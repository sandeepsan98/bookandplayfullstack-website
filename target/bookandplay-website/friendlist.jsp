...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/friendlist.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/js/friendlist.js"></script>
</body>
</html>
